...
def create_consensus(in_fasta,in_metadata,index_field,index_column,clade_file,out_fasta):
    ...
    for key, value in consensus_dic.items():
        ...
        SeqIO.write(record, consensus_file, "fasta-2line")
    consensus_file.close()

consensus = argparse.ArgumentParser(description='Collapses sequences into consensus sequences based on grouping by index field')
